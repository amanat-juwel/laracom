        ...
        <section class="content">
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12">
                            <form class="form" action="{{ url('roles/store') }}" method="post" >
                                {{ csrf_field() }}
                                <div class="form-group">
                                    <label for="">Name</label>
                                    <input type="text" autocomplete="OFF" name="name" placeholder="Name" class="form-control input-sm" />
                                    @if($errors->has('name'))
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" autocomplete="OFF" name="display_name" placeholder="Display Name" class="form-control input-sm" />
