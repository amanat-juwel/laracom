...
<section class="content">
    <div class="">
        <div class="">
            <!--ADD ROW -->
            <div class="row">
                <form class="form" action="{{ url('admin/purchase-return') }}" method="post" id="yoyo">
                {{ csrf_field() }}
                <div class="col-md-12">
                                ...
                                <table class="table table-striped" style="margin-bottom: 0px">
                                    ...
                                    <tbody class="neworderbody">
                                        <tr>
                                            ...
                                            <td>
                                                <input autocomplete="off" type="text" class="qty form-control input-sm" name="qty[]" value="1" pattern="[0-9]+" title="Digit only" required="">
                                            </td>
                                            <td>
                                                <input autocomplete="off" type="text" class="price form-control input-sm" name="price[]" id="firstRowPrice" value="" required="">
                                                <input type="hidden" class="dis form-control input-sm" value="0" name="dis[]" >
                                            </td>
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body" style="padding: 5px">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <input type="hidden" name="discount"  id="discount" class="form-control input-sm" value=""/>
                                            <input type="hidden" name="advanced_amount" id="advancePaid"  class="form-control input-sm"  autocomplete="OFF" />
        ...
        $('.add').click(function () {
            ...
            if($('#firstRowProduct').val() == ''){
                ...
                var tr = '<tr><td class="no">' + n + '</td>' + '<td><select class="form-control product_id select2" name="product_id[]" required>' + product + '</select></td>' +
                    ...
                    '<td><input autocomplete="off" type="text" class="qty form-control input-sm" name="qty[]" value="1" pattern="[0-9]+" title="digit only" required></td>' +
                    '<td><input autocomplete="off" type="text" class="price form-control input-sm" name="price[]" value="" required><input type="hidden" class="dis form-control input-sm" name="dis[]" value="0"></td>' +
