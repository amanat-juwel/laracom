...
<section class="content">
    <div class="panel panel-primary">
        <div class="panel-heading">
            <a href="{{ url('/sales') }}" class="btn btn-default btn-sm"><i class="fa fa-plus-circle"></i> Add New</a>
        </div>
                                ...
                                @if(isset($sales_detail))
                                    @foreach($sales_detail as $key => $sales_details)
                                        <tr>
                                            ...
                                            <td>{{ date('F j, Y', strtotime($sales_details->sales_date)) }}</td>
                                           <!--  @if($sales_details->status == "Due")
                                            ...
                                            <td style="text-align: center">
                                                <a style="" title="View Sales Details" target="" class="btn btn-info btn-xs" href="{{ url('/sales/memo_details/'.$sales_details->sales_master_id)  }}"><i class="fa fa-eye"></i> View</a>
                                                <a style="" title="Print Invoice" target="_blank" class="btn btn-primary btn-xs" href="{{ url('/sales/invoice/'.$sales_details->sales_master_id) }}"><i class="fa fa-print"></i> Print</a>
                                                ...
                                                @if(Auth::user()->role == 'inventory' ||Auth::user()->role == 'admin')
                                                <form action="{{ url('/sales/'.$sales_details->sales_master_id) }}" method="post" style="display:inline-block">
