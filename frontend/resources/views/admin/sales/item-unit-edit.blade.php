                        ...
                        <div class="col-md-12">
                            ...
                            <form class="form" name="editForm" action="{{ url('admin/sales/invoice/unit/'.$sales_master_id)}}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="quantity" value="{{ $itemUnitById->quantity }}" class="form-control input-sm" required/>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="sales_price" value="{{ $itemUnitById->sales_price }}" class="form-control input-sm" required/>
