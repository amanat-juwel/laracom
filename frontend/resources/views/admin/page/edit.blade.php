...
<!-- Main content -->
<div class="row">
    <form class="form" action="{{ url('admin/pages/'.$page->id) }}" method="post" enctype="multipart/form-data">
    {{ method_field('PUT') }}
    {{ csrf_field() }}
        <div class="col-md-6">
                              ...
                              <div class="box box-primary box-solid">
                                ...
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <input autocomplete="OFF" placeholder="The tile for your post" type="text" name="title" id="title" class="form-control input-sm" value="{{ $page->title }}" required/>
                                        @if($errors->has('title'))
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input autocomplete="OFF" placeholder="Small description of this post" type="text" name="excerpt" class="form-control input-sm" value="{{ $page->excerpt }}"/>
                                       ...
                                       <section class="custom-note">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3 input-group-sm">
                                                    ...
                                                    <textarea class="form-control" rows="10" id="summernote" name="body">{{ $page->body }}</textarea>
                                                </div>
                                            </div>
                                        </section> 
                                    </div>
                              ...
                              <div class="box box-warning box-solid">
                                ...
                                <div class="box-body">
                                  <div class="form-group">
                                        ...
                                        <input type="text" autocomplete="OFF" name="slug" id="slug" value="{{ $page->slug }}" class="form-control input-sm" required/>
                                        @if($errors->has('slug'))
                              ...
                              <div class="box box-primary box-solid">
                                ...
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <img src='{{ asset("$page->image") }}' height="120" width="140">
                              ...
                              <div class="box box-info box-solid">
                                ...
                                <div class="box-body">
                                  <div class="form-group">
                                        ...
                                        <textarea name="meta_description" class="form-control input-sm" rows="2" />{{ $page->meta_description }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" autocomplete="OFF" name="meta_keywords" placeholder="" value="{{ $page->meta_keywords }}" class="form-control input-sm"/>
